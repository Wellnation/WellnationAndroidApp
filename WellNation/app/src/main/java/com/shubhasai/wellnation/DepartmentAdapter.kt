...
class DepartmentAdapter(private val context: Context?,val hospitalsdep: ArrayList<DepartmentData>, val listener: DeptClicked) : RecyclerView.Adapter<DepartmentAdapter.ViewHolder>(){
